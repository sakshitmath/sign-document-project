                  ...
                  <tr key={doc.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="py-2">
                      <div className="flex gap-2">
                        ...
                        {doc.status === 'SIGNED' && (
                          <a href={`${import.meta.env.VITE_BACKEND_URL || 'http://localhost:8081'}/api/documents/download/${doc.id}`} target="_blank" rel="noreferrer" className="bg-green-600 text-white px-3 py-1 rounded text-sm hover:bg-green-700">
                            Download
                          </a>
                        )}
                      </div>
